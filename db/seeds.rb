...
user = User.create :email => "admin@a.de", :password => "123456", :password_confirmation => "123456", :nick => "ADMIN", :alive => true
user = User.first
user.roles = %w[admin]
user.save

user = User.create :email => "a@a.de", :password => "123456", :password_confirmation => "123456", :nick => "BBKing", :alive => true

user = User.create :email => "ab@a.de", :password => "123456", :password_confirmation => "123456", :nick => "ChuckBerry", :alive => true

user = User.create :email => "abc@a.de", :password => "123456", :password_confirmation => "123456", :nick => "AngusYoung", :alive => true

user = User.create :email => "abcd@a.de", :password => "123456", :password_confirmation => "123456", :nick => "SRV", :alive => true

user = User.create :email => "abcde@a.de", :password => "123456", :password_confirmation => "123456", :nick => "GlennMiller", :alive => true

user = User.create :email => "abcdef@a.de", :password => "123456", :password_confirmation => "123456", :nick => "JimmyPage", :alive => true
